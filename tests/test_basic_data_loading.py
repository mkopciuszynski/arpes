        ...
        (
            "phelix_load_cut",
            {
                ...
                "expected": {
                    ...
                    "probe": None,
                    "probe_detail": None,
                    "analyzer_detail": {"analyzer_name": "Specs PHOIBOS 225",
                    "parallel_deflectors": True,
                    "perpendicular_deflectors": True,
                    "analyzer_type": "hemispherical",
                    "analyzer_radius": 225},
                    ...
                    "beamline_info": {
                      "hv": pytest.approx(60.0),
                        "linewidth": np.nan,
                        "photon_polarization": (np.nan, np.nan),
                        "undulator_info": {"gap": None,
                        "z": None,
                        "harmonic": None,
                        "polarization": None,
                        "type": None},
                    ...
                    "daq_info": {
                        ...
                        "trapezoidal_correction_strategy": None,
                        "dither_settings": None,
                        "sweep_settings": {"high_energy": None,
                        "low_energy": None,
                        "n_sweeps": None,
                        "step": None},
                        "frames_per_slice": np.nan,
            ...
            "phelix_load_cut",
            {
                ...
                "expected": {
                    ...
                    "coords": {
                        ...
                        "alpha": np.deg2rad(90),
                        "psi": 0.0,
                        "eV": [-2.021999, 0.5, 0.006321],
                        "phi": [-0.261145, 0.261145, 0.001309],
                    },
                    "offset_coords": {},
                },
            },
